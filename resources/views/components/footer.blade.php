<footer class="bg-white dark:bg-gray-800 shadow-md mt-auto">
    <div class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Навигация</h3>
                <ul class="space-y-2">
                    <li>
                        <a href="{{ route('home') }}" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">Главная</a>
                    </li>
                    <li>
                        <a href="{{ route('houses.index') }}" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">Каталог домов</a>
                    </li>
                    <li>
                        <a href="{{ route('pages.show', 'about') }}" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">О компании</a>
                    </li>
                    <li>
                        <a href="{{ route('pages.show', 'delivery-and-payment') }}" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">Доставка и оплата</a>
                    </li>
                    <li>
                        <a href="{{ route('pages.show', 'contacts') }}" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">Контакты</a>
                    </li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2">
                    <li class="flex items-start">
                        ...
                        <span class="text-gray-600 dark:text-gray-300">г. Москва, ул. Примерная, д. 123</span>
                    </li>
                    <li class="flex items-center">
                        ...
                        <a href="tel:+79991234567" class="text-gray-600 hover:text-blue-600 dark:text-gray-300 dark:hover:text-white">+7 (999) 123-45-67</a>
                    </li>
                    <li class="flex items-center">
                        <svg class="w-5 h-5 text-gray-500 dark:text-gray-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
